...
namespace mqtt
{
    ...
    void mqttCallback(char *topic, byte *payload, unsigned int len)
    {
        ...
        if (!doc["command"]["POWER0"].isNull())
        {
            relays::SwitchRelay(0, (bool)((String)doc["command"]["POWER0"] == "on" ? true : false));
        }
        else if (!doc["command"]["POWER1"].isNull())
        {
            relays::SwitchRelay(1, (bool)((String)doc["command"]["POWER1"] == "on" ? true : false));
        }
        else if (!doc["command"]["POWER2"].isNull())
        {
            relays::SwitchRelay(2, (bool)((String)doc["command"]["POWER2"] == "on" ? true : false));
        }
        else if (!doc["command"]["POWER3"].isNull())
        {
            relays::SwitchRelay(3, (bool)((String)doc["command"]["POWER3"] == "on" ? true : false));
        }
        else if (!doc["command"]["POWER4"].isNull())
        {
            relays::SwitchRelay(4, (bool)((String)doc["command"]["POWER4"] == "on" ? true : false));
        }
        else if (!doc["command"]["POWER5"].isNull())
        {
            relays::SwitchRelay(5, (bool)((String)doc["command"]["POWER5"] == "on" ? true : false));
        }
        else if (!doc["command"]["POWER6"].isNull())
        {
            relays::SwitchRelay(6, (bool)((String)doc["command"]["POWER6"] == "on" ? true : false));
        }
        else if (!doc["command"]["POWER7"].isNull())
        {
            relays::SwitchRelay(7, (bool)((String)doc["command"]["POWER7"] == "on" ? true : false));
        }
